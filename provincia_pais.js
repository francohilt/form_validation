...
var provincias_2=new Array("","Buenos Aires","Salta","San Juan","San Luis","La Rioja","La Pampa");
...
var provincias_4=new Array("","Aisne","Creuse","Dordogne","Essonne","Gironde");
  ...
  function cambia_provincia(){ 
   	...
   	var pais 
   	pais = document.form1.pais[document.form1.pais.selectedIndex].value 
   	...
   	if (pais != 0) { 
      	...
      	document.form1.provincia.options[0].value = ""
